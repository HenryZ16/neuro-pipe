...
class DPABIProcessor:
    ...
    def preprocess_data(self,input: dict):
        ...
        Cfg['IsNeedReorientFunImgInteractively'] = input['IsNeedReorientFunImgInteractively']

        # T1像处理设置
        Cfg['IsNeedConvertT1DCM2IMG'] = input['IsNeedConvertT1DCM2IMG']
        Cfg['IsNeedReorientCropT1Img'] = input['IsNeedReorientCropT1Img']
        Cfg['IsNeedReorientT1ImgInteractively'] = input['IsNeedReorientT1ImgInteractively']
        Cfg['IsBet'] = input['IsBet']
        Cfg['IsAutoMask'] = input['IsAutoMask']
        Cfg['IsNeedT1CoregisterToFun'] = input['IsNeedT1CoregisterToFun']
        Cfg['IsNeedReorientInteractivelyAfterCoreg'] = input['IsNeedReorientInteractivelyAfterCoreg']

        # 分割设置
        Cfg['IsSegment'] = input['IsSegment']
        Cfg['Segment'] = eng.struct()
        Cfg['Segment']['AffineRegularisationInSegmentation'] = input['Segment']['AffineRegularisationInSegmentation']
        ...
        Cfg['Covremove']['IsHeadMotionScrubbingRegressors'] = input['Covremove']['IsHeadMotionScrubbingRegressors']
        Cfg['Covremove']['HeadMotionScrubbingRegressors'] = eng.struct()
        Cfg['Covremove']['HeadMotionScrubbingRegressors']['FDType'] = input['Covremove']['HeadMotionScrubbingRegressors']['FDType']
        Cfg['Covremove']['HeadMotionScrubbingRegressors']['FDThreshold'] = input['Covremove']['HeadMotionScrubbingRegressors']['FDThreshold']
        Cfg['Covremove']['HeadMotionScrubbingRegressors']['PreviousPoints'] = input['Covremove']['HeadMotionScrubbingRegressors']['PreviousPoints']
        Cfg['Covremove']['HeadMotionScrubbingRegressors']['LaterPoints'] = input['Covremove']['HeadMotionScrubbingRegressors']['LaterPoints']
        ...
        Cfg['Covremove']['WM']['MaskThreshold'] = input['Covremove']['WM']['MaskThreshold']
        Cfg['Covremove']['WM']['Method'] = input['Covremove']['WM']['Method']
        Cfg['Covremove']['WM']['CompCorPCNum'] = input['Covremove']['WM']['CompCorPCNum']
        ...
        Cfg['Covremove']['CSF']['MaskThreshold'] = input['Covremove']['CSF']['MaskThreshold']
        Cfg['Covremove']['CSF']['Method'] = input['Covremove']['CSF']['Method']
        Cfg['Covremove']['CSF']['CompCorPCNum'] = input['Covremove']['CSF']['CompCorPCNum']

        Cfg['Covremove']['WholeBrain'] = eng.struct()
        Cfg['Covremove']['WholeBrain']['IsRemove'] = input['Covremove']['WholeBrain']['IsRemove']
        Cfg['Covremove']['WholeBrain']['IsBothWithWithoutGSR'] = input['Covremove']['WholeBrain']['IsBothWithWithoutGSR']
        Cfg['Covremove']['WholeBrain']['Mask'] = input['Covremove']['WholeBrain']['Mask']
        Cfg['Covremove']['WholeBrain']['Method'] = input['Covremove']['WholeBrain']['Method']

        Cfg['Covremove']['OtherCovariatesROI'] = input['Covremove']['OtherCovariatesROI']
        ...
        Cfg['Normalize']['AffineRegularisationInSegmentation'] = input['Normalize']['AffineRegularisationInSegmentation']
        ...
        Cfg['CalDegreeCentrality']['rThreshold'] = input['CalDegreeCentrality']['rThreshold']
        ...
        # VMHC分析设置
        Cfg['IsNormalizeToSymmetricGroupT1Mean'] = input['IsNormalizeToSymmetricGroupT1Mean']
...
if __name__ == "__main__":
    cfg: dict = {
        ...
        'SubjectID': {'sub02'},  # This would need to be converted to MATLAB cell array if using MATLAB engine
        'TimePoints': 0,
        'TR': 0,
        ...
        'SliceTiming': {
            'SliceNumber': 0,
            'SliceOrder': list(range(1, 34, 2)) + list(range(2, 33, 2)),  # Would need to convert to MATLAB int32 array
            'ReferenceSlice': 0,
            'TR': 0,
            'TA': 0
        },
        ...
        'Normalize': {
            ...
            'BoundingBox': [[-90, -126, -72], [90, 90, 108]],  # Would need to be matlab.double array
        ...
        'IsCWAS': 0,
        'CWAS': {
            'Regressors': [],  # Would need to be matlab.double array
            'iter': 0
        },
